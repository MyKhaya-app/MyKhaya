...
import type { CalendarUsage, EventLabel, HomeCalendar } from "@mykhaya/shared-types";
...
// The canonical "Calendar Tags" (CalendarEventLabel) management surface —
// previously inlined into Home settings, now its own page (see
// app/settings/calendar-tags/page.tsx) reached from More. Deliberately
// separate from Home calendars (/calendar/calendars): a Calendar Tag
// colours/organises events across calendars, it is never a calendar of its
// own — see docs/architecture/commercial-entitlements.md "Event categories
// are CalendarEventLabel, not HomeCalendar".
export function CalendarTagsManager({ homeId }: { homeId: string }) {
